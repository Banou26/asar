...
export var SIZE_INT64 = 8;
export var SIZE_UINT64 = 8;
export var SIZE_FLOAT = 4;
export var SIZE_DOUBLE = 8;
// The allocation granularity of the payload.
export var PAYLOAD_UNIT = 64;
// Largest JS number.
export var CAPACITY_READ_ONLY = 9007199254740992;
// Aligns 'i' by rounding it up to the next multiple of 'alignment'.
export var alignInt = function (i, alignment) { return i + (alignment - (i % alignment)) % alignment; };
// PickleIterator reads data from a Pickle. The Pickle object must remain valid
// while the PickleIterator object is in use.
var PickleIterator = /** @class */ (function () {
...
var Pickle = /** @class */ (function () {
    ...
    Pickle.prototype.writeInt64 = function () {
        throw new Error('Int64 not supported in the browser');
    };
    Pickle.prototype.writeUInt64 = function () {
        throw new Error('UInt64 not supported in the browser');
    };
...
export var createEmpty = function () { return new Pickle(); };
export var createFromBuffer = function (buffer) { return new Pickle(buffer); };
